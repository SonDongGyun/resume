...
function callback(){
      ...
      if(lotto.length == 6){
          console.log('5주전-0714 : ' + lotto);
         if(lotto[0] == 3 && lotto[1] == 4  && lotto[2] == 6
            && lotto[3] == 8 && lotto[4] == 32 && lotto[5] == 42){  
              var J=0;
  ...
  function callback2(lotto , gb){
      ...
      if(lotto2[0] == 7 && lotto2[1] == 9  && lotto2[2] == 11
            && lotto2[3] == 21 && lotto2[4] == 30 && lotto2[5] == 35){          
  ...
  function callback3(lotto ,lotto2, gb){
    ...
    if(lotto3.length == 6){
      ...
      if(lotto3[0] == 3 && lotto3[1] == 7  && lotto3[2] == 15
            && lotto3[3] == 16 && lotto3[4] == 19 && lotto3[5] == 43){     
  ...
  function callback4(lotto , lotto2 , lotto3 , gb){
    ...
    if(lotto4.length == 6){
      ...
      console.log('2주전 : ' + lotto4);
        if(lotto4[0] == 3 && lotto4[1] == 16  && lotto4[2] == 18
            && lotto4[3] == 24 && lotto4[4] == 40 && lotto4[5] == 44){     
  ...
  function callback5(lotto , lotto2 , lotto3 , lotto4, gb){
      ...
      if(lotto5.length == 6){
         ...
         if(lotto5[0] == 6 && lotto5[1] == 12  && lotto5[2] == 18
            && lotto5[3] == 37 && lotto5[4] == 40 && lotto5[5] == 41){     
